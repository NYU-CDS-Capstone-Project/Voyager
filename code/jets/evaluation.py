...
MODELS_DIR = '/home/psn240/capstone/dev/jets/'
REPORTS_DIR = '/scratch/psn240/capstone/data/w-vs-qcd/reports/'
...
def main():
    ...
    for data_path in data_paths:
        for model_path, label, color in zip(model_paths, labels, colors):
            ...
            logging.info("R, F, T shape"+ str(len(r))+ str(len(f))+str(len(t)))
